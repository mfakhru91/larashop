...
class BookController extends Controller
{
    ...
    public function destroy($id)
    {
        ...
        return redirect()->route('books.index')->with('status','Book successfully delete');
    }

    public function trash()
    {
      $deleted_category =\App\Book::onlyTrashed()->paginate(10);
      return view('books.trash',['books'=>$deleted_category]);
    }
