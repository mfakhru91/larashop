...
<head>
 ...
 <link rel="stylesheet" href="https://azamuddin.github.io/polished-template/iconic/css/open-iconic-bootstrap.min.css">
 <link rel="stylesheet" href="https://azamuddin.github.io/polished-template/polished.min.css">
...
<li>
  <a href="{{route('categories.index')}}"><span class="oi oi-tag"></span>Manager categories</a>
</li>
<li>
  <a href="{{route('books.index')}}"><span class="oi oi-book"></span>Manage books</a>
</li>
<li>
  <a href="{{route('orders.index')}}"> <span class="oi oi-inbox"></span> Manager orders</a>
</li>
