...
@section("content")
        ...
        Current avatar: <br>
        @if($user->avatar)
        <img src="{{asset('storage/app/public/'.$user->avatar)}}"width="120px" />
        <br>
        @else
        No avatar
        @endif
        ...
        <input
        value="{{$user->email}}"disabled class="form-control"placeholder="user@mail.com"type="text" name="email"id="email"/>
        <br>
